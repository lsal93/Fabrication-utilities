...
m_package = Package(name='FABLIMS Equipment Schema rev3')
...
class ItemPermittedPropertyDefinition(EntryData, ArchiveSection):
    '''
    Class autogenerated from yaml schema.
    '''
    m_def = Section()
...
class EquipmentParameterDefinition(EntryData, ArchiveSection):
    '''
    Class autogenerated from yaml schema.
    '''
    m_def = Section()
    ...
    def normalize(self, archive: 'EntryArchive', logger: 'BoundLogger') -> None:
        '''
        The normalizer for the `EquipmentParameterDefinition` class.
...
class EquipmentParameterData(EquipmentParameterDefinition, ArchiveSection):
    '''
    Class autogenerated from yaml schema.
    '''
    m_def = Section()
